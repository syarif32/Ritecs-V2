...
@section('title', 'System Maintenance | RITECS')
@section('content')
    <div class="container-fluid">
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <i class="fe fe-check"></i> {{ session('success') }}
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
        ...
        @if (request('rebuild_status') == 'success')
            <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('admin.maintenance.clear', 'config') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('admin.maintenance.clear', 'route') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('admin.maintenance.clear', 'view') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-danger shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('admin.maintenance.clear', 'optimize') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-dark shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form id="clearLogsForm" action="{{ route('admin.maintenance.clearLogs') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ route('admin.maintenance.clear', 'rebuild') }}" method="POST">
                            @csrf
