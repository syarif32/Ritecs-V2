      ...
      <div class="card shadow mb-4">
        <div class="card-body">
         ...
         {{-- Success Message --}}
          ...
          <form id="mainForm" action="{{ route('admin.manageUserMemberships.store') }}" method="POST">
            @csrf
            ...
            <input type="hidden" name="guest_email_original" value="{{ old('guest_email') }}">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="guest_first_name" name="guest_first_name" class="form-control" value="{{ old('guest_first_name') }}">
              </div>
              <div class="col-md-6 mb-3">
                <label>Last Name</label>
                <input type="text" id="guest_last_name" name="guest_last_name" class="form-control" value="{{ old('guest_last_name') }}">
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="guest_institution" name="guest_institution" class="form-control" value="{{ old('guest_institution') }}">
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="date" class="form-control" name="end_date" value="{{ old('end_date', now()->addYear()->format('Y-m-d')) }}" required>
              </div>
