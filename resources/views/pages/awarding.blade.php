        ...
        <div class="container p-0 m-0 w-100 m-auto">
            ...
            <div class="card mb-3 h-100 border-0 shadow-none m-auto p-2 ps-4 pb-4 mb-5 position-relative" style="max-width: 1100px;">
                <div class="position-absolute bg-warning px-3 py-1 rounded" style="margin-left: -1.5rem !important; margin-top: -.5rem !important;">
                    <h4 class="display-6 fst-italic text-white p-0 m-0">#{{ $selected->awarding_id }}</h4>
                </div>
                <div class="row g-0 m-auto">
                    <div class="col-12 col-md-4 col-xl-3 pt-lg-2 pt-3">
                        <div class="blog-img rounded shadow">
                            <img id="selected-cover" src="{{ asset($selected->cover_path ?? 'assets/published/awarding/award_default.png') }}" 
                    ...
                    <div class="col-12 col-md-8 col-xl-9">
                        <div class="card-body ps-md-4 ps-lg-5 ps-2 pt-lg-3 pt-4">
                            <h3 class="d-inline-block mb-3"id="selected-title">{{ $selected->title }}</h3>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                            <span class="ms-2">
                                                ...
                                                <span id="selected-penulis">{{ $selected->penulis ?? '-' }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                            <span class="ms-2">
                                                ...
                                                <span id="selected-volume">{{ $selected->volume_no ?? '-' }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                            <span class="ms-2">
                                                ...
                                                <span id="selected-jenis">{{ $selected->jenis_jurnal ?? '-' }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                            <span class="ms-2">
                                                ...
                                                @if($selected->url_path)
                                                    <a href="{{ $selected->url_path }}" target="_blank" id="selected-url">{{ $selected->url_path }}</a>
                                                @else
                                                    -
                                                @endif
                                            </span>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="ms-2">
                                                ...
                                                <span id="selected-keywords">
                                                    @if($selected->keywords && $selected->keywords->count() > 0)
                                                        @foreach($selected->keywords as $key)
                                                            <span>{{ $key->name }}@if(!$loop->last), @endif</span>
                                                        @endforeach
                                                    @else
                                                        -
                                                    @endif
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="blog-item rounded">
                            <div class="blog-img rounded-top">
                                <img src="{{ asset($award->cover_path ?? 'assets/published/awarding/award_default.png') }}" class="img-fluid rounded-top w-100" alt="">
                            </div>
                            <div class="blog-content h-100 rounded p-3 d-grid align-content-between">
                                <div class="card-body p-0 m-0">
                                    <a href="javascript:void(0)#idJournal" onclick="loadAwarding({{ $award->awarding_id }})" 
                                    class="h6 d-inline-block mb-2">{{ $award->title }}</a>
                                    <div class="kata-kunci my-1">
                                        <p class="h6 small mb-0">Kata Kunci :</p>
                                        @foreach($award->keywords as $keyword)
                                            <span class="keywords-badge py-0 small my-1 ms-0 me-1">{{ $keyword->name }}</span>
                                        @endforeach
                                    </div>
                                </div>
                                
                                <a href="javascript:void(0)" onclick="loadAwarding({{ $award->awarding_id }})" class="d-flex align-items-center p-0 text-dark">
                        ...
                        <div class="col-md-6 col-xxl-4 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="blog-item rounded">
                                ...
                                <div class="blog-content h-100 rounded p-3 d-grid align-content-between">
                                    ...
                                    <a href="{{ $journal->url_path }}" target="_blank" class="p-d-flex align-items-center  text-dark position-relative bottom-0"><span class="small">Detail jurnal</span><i class="text-dark bi bi-arrow-up-short fw-bold h5 ms-1 p-0 m-0"></i></a>
                                </div>
                            </div>
                        </div>
                        @empty
