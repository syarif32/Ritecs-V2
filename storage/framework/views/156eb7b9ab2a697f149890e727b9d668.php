            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="pricing-card popular h-100">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php $__empty_1 = true; $__currentLoopData = $featured_benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="card-footer text-center">
                        <a href="<?php echo e(route('profile.member')); ?>" class="btn btn-primary rounded-pill w-100">Pilih Paket</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/membership.blade.php ENDPATH**/ ?>