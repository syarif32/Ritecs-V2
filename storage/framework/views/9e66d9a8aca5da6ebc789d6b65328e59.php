...
<?php $__env->startSection('content'); ?>
                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row g-4 align-items-center">
                            ...
                            <h6 class="text-white fw-bold mb-4"><?php echo nl2br(e($carousel->subtitle)); ?></h6>
                            <?php endif; ?>
                                    ...
                                    <div class="d-flex justify-content-center justify-content-md-start flex-shrink-0 mb-4">
                                        <?php if($carousel->button1_text && $carousel->button1_url): ?>
                                            <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2" href="<?php echo e($carousel->button1_url); ?>"><i class="fas fa-play-circle me-2"></i><?php echo e($carousel->button1_text); ?></a>
                                        <?php endif; ?>
                                        <?php if($carousel->button2_text && $carousel->button2_url): ?>
                                            <a class="btn btn-dark rounded-pill py-3 px-4 px-md-5 ms-2" href="<?php echo e($carousel->button2_url); ?>"><?php echo e($carousel->button2_text); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item h-100 p-4 pt-0">
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4 <?php echo e(($title ?? '') === 'Petunjuk Penulis' ? 'active' : ''); ?>" href="<?php echo e(route('petunjuk-penulis')); ?>#petunjuk-penulis">Learn More</a>
                        </div>
                    </div>
    ...
    Tim kami siap membantu penulis dan peneliti dalam mempublikasikan hasil karya ilmiahnya agar dapat diakses secara luas dan diakui secara akademik.
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4" href="<?php echo e(route('layanan-journal')); ?>#layanan-jurnal">Learn More</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item h-100 p-4 pt-0">
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4 <?php echo e(($title ?? '') === 'Membership' ? 'active' : ''); ?>" href="<?php echo e(route('membership')); ?>#petunjuk-penulis">Learn More</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item h-100 p-4 pt-0">
                            ...
                            <a class="btn btn-primary rounded-pill py-2 px-4 <?php echo e(($title ?? '') === 'Membership' ? 'active' : ''); ?>" href="<?php echo e(route('training-center')); ?>#training">Learn More</a>
                        </div>
                    </div>
                ...
                <div class="feature-item h-100 p-4 pt-0">
                    ...
                    <a class="btn btn-primary rounded-pill py-2 px-4 <?php echo e(($title ?? '') === 'Layanan HAKI' ? 'active' : ''); ?>" href="<?php echo e(route('layanan-haki')); ?>">Learn More</a>
                </div>
            </div>
                    <!-- <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="feature-item h-100 p-4 pt-0">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="blog-item rounded">
                        ...
                        <div class="blog-content h-100 rounded p-3 d-grid align-content-between">
                            ...
                            <a href="<?php echo e($journal->url_path); ?>" target="_blank" class="p-0 text-dark small">Detail jurnal<i class="fa fa-arrow-right ms-2 small"></i></a>
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $home_faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading<?php echo e($faq->id); ?>">
                                        <button class="accordion-button border-0 <?php echo e($loop->first ? '' : 'collapsed'); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo e($faq->id); ?>" aria-expanded="<?php echo e($loop->first ? 'true' : 'false'); ?>">
                                            Q: <?php echo e($faq->question); ?>

                                        </button>
                                    </h2>
                                    <div id="collapse<?php echo e($faq->id); ?>" class="accordion-collapse collapse <?php echo e($loop->first ? 'show' : ''); ?>" data-bs-parent="#accordionExample">
        ...
        <div class="row g-4">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="team-item">
                        <div class="team-img">
                            <img src="<?php echo e(asset('storage/' . $team->img_path)); ?>" alt="<?php echo e($team->name); ?>" class="img-fluid rounded-top w-100">
                            <div class="team-icon">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/home.blade.php ENDPATH**/ ?>