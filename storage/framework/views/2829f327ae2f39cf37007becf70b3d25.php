        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4 text-start"> 
                ...
                <div class="d-grid gap-2">
                    <button class="btn btn-outline-dark btn-sm py-2" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#manualActivationModal">
                        Masih berkendala? Hubungi Admin
                    </button>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- TAMBAHAN: Logika Alert Sukses & Logout Otomatis ---
        ...
        const formRequest = document.querySelector('#manualActivationModal form');
