<!-- Buku Start -->
                    ...
                    <div class="d-flex gap-4">
                        <div class="blog-item card-buku">
                            ...
                            <div class="blog-content p-3">
                                ...
                                <a href="<?php echo e(('detail-buku')); ?>" class="p-0">Lihat Buku <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="blog-item card-buku">
                            <div class="blog-img rounded-top">
        ...
        <div class="container-fuild">
                    <div class="row g-4 justify-content-start text-start">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                            <div class="blog-item rounded">
                                <div class="blog-content rounded p-3">
                                    <div class="blog-comment d-flex justify-content-between mb-2">
                                        <div class="small"><i class="bi bi-person-lines-fill text-primary me-1"></i>Aditya Priadi P, <span class="text-primary"> 3+ </span></div>
                                        <div class="small"><i class="bi bi-calendar-range text-primary"></i> 1 Dec 2025</div>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-3 wow fadeInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                            <div class="blog-item rounded">
                                <div class="blog-content rounded p-3">
                                    <div class="blog-comment d-flex justify-content-between mb-2">
                                        <div class="small"><i class="bi bi-person-lines-fill text-primary me-1"></i>Riby Imanuel, <span class="text-primary"> 2+ </span></div>
                                        <div class="small"><i class="bi bi-calendar-range text-primary"></i> 6 Aug 2025</div>
                                    </div>
...
<?php $__env->startSection('title', 'Explore Our Subjects'); ?>
                ...
                <div class="col-md-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="blog-item rounded">
                        <div class="blog-content rounded p-3">
                            ...
                            <a href="<?php echo e(('detail-jurnal')); ?>" class="p-0 text-dark small">Detail jurnal<i class="fa fa-arrow-right ms-2 small"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/test.blade.php ENDPATH**/ ?>