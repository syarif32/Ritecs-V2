                                    ...
                                    <tr>
                                            ...
                                            <?php if($log->actor): ?>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm mr-2">
                                                        <img src="<?php echo e($log->actor->img_path ? asset($log->actor->img_path) : asset('backend/assets/images/user.svg')); ?>" 
                                                             alt="..." 
                                        ...
                                        <td>
                                            <?php if($log->target): ?>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-sm mr-2">
                                                        <img src="<?php echo e($log->target->img_path ? asset($log->target->img_path) : asset('backend/assets/images/user.svg')); ?>" 
                                                             alt="..." 
                                                             class="avatar-img rounded-circle"
                                                             style="object-fit: cover;">
                                                    </div>
...
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/usersmanagement/history.blade.php ENDPATH**/ ?>