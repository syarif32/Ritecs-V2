                ...
                <form id="searchForm" action="<?php echo e(route('membership.index')); ?>" method="GET">
                    ...
                    <div class="input-group input-group-lg shadow-sm">
                        <input type="search" name="search" class="form-control border-end-0"
                            placeholder="Cari nama anggota atau kode member..." aria-label="Search" value="<?php echo e(request('search')); ?>">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                        <div class="text-muted small">Menampilkan <?php echo e($memberships->firstItem() ?? 0); ?>-<?php echo e($memberships->lastItem() ?? 0); ?> dari <?php echo e($memberships->total()); ?> hasil</div>
                        <div>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="card h-100 shadow-sm border-0 rounded-4">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <h5 class="card-title mb-1 text-truncate" title="<?php echo e($membership->user ? $membership->user->first_name . ' ' . $membership->user->last_name : $membership->guest_first_name . ' ' . $membership->guest_last_name); ?>">
                                        <?php if($membership->user): ?>
                                            
                                            <?php echo e($membership->user->first_name); ?> <?php echo e($membership->user->last_name); ?>

                                        <?php else: ?>
                                            
                                            <?php echo e($membership->guest_first_name); ?> <?php echo e($membership->guest_last_name); ?>
                                    ...
                                    <p class="text-muted small mb-3">
                                        ID: <?php echo e($membership->member_number); ?>

                                        
                                        <?php if(!$membership->user && $membership->guest_institution): ?>
                                            <br><span class="fst-italic"><?php echo e($membership->guest_institution); ?></span>
                                        <?php endif; ?>
                                    </p>

                                    
                                    <span class="badge <?php echo e($membership->status == 1 ? 'bg-success text-white' : 'bg-secondary text-white'); ?> rounded-pill px-3 py-2">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/membership/index.blade.php ENDPATH**/ ?>