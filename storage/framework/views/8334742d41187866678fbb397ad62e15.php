                            ...
                            <div class="footer-item">
                               ...
                               <h4 class="mb-4 text-white"><?php echo e($global_settings['footer_instagram_title'] ?? 'Instagram'); ?></h4>
                                <div class="row g-3">
                                   ...
                                   <?php $__empty_2 = true; $__currentLoopData = $footer_galleries ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
    <div class="col-4">
...
<a href="#" class="btn btn-primary btn-lg-square rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/partials/footer.blade.php ENDPATH**/ ?>