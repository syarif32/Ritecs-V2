            ...
            <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="contact-img d-flex justify-content-center">
                    <div class="contact-img-inner">
                        <img src="<?php echo e(asset('assets/img/logo/logo.webp')); ?>" class="img-fluid w-75 p-5" alt="Image">
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="Your Name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-12 col-xl-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control border-0 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="address" name="address" placeholder="Your Address" value="<?php echo e(old('address')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control border-0 <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control border-0 <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Leave a message here" id="message" name="message" style="height: 120px"><?php echo e(old('message')); ?></textarea>
        ...
        <div class="row g-4 mb-5"> 
            ...
            <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="contact-add-item">
                    ...
                    <div>
                        <h4>Site</h4>
                        <p class="mb-0"><?php echo e($site); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row wow fadeInUp" data-wow-delay="0.2s">
            <div class="col-12">
                <div class="rounded">
                    ...
                    style="height: 400px;" src="<?php echo e($map_link); ?>" 
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/contact.blade.php ENDPATH**/ ?>