...
<div class="container-fluid feature bg-light pb-5 pt-3">
    ...
    <div class="container">
        <p class="normal-text">Publish > <a class="normal-text" href="<?php echo e(route('buku')); ?>">Buku</a> > <a class="text-dark small" href="#"><?php echo e($book->title); ?></a></p>
    </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-4">
                        <div class="blog-img rounded shadow">
                            <img src="<?php echo e(asset($book->cover_path)); ?>" class="img-fluid w-100 object-fit-contain rounded-start rounded-end" alt="<?php echo e($book->title); ?>">
                        </div>
                    </div>
                        ...
                        <div class="card-body ps-md-4 ps-lg-5 ps-2 pt-lg-3 pt-4">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="d-flex align-items-center text-dark">
                                    ...
                                    <span><?php echo e(number_format($book->visitor_count, 0, ',', '.')); ?> x dilihat</span>
                                </div>
                                ...
                                <div class="d-flex align-items-center text-dark">
                                    ...
                                    <span><?php echo e(number_format($book->download_count, 0, ',', '.')); ?> x diunduh</span>
                                </div>
                            </div>
                            <div class="d-grid justify-content-start mb-3 flex-wrap">
                                ...
                                <div class="content my-1">
                                    ...
                                    <span>
                                        ...
                                        <span>
                                            <?php $__currentLoopData = $book->writers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $writer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo e($writer->name); ?><?php echo e(!$loop->last ? ', ' : ''); ?>
                                ...
                                <div class="content my-1 d-flex">
                                    ...
                                    <span class="d-grid d-md-flex align-items-center">
                                        ...
                                        <span class="bg-warning-soft rounded-pill my-1 my-md-0 px-3 py-0 text-dark small mx-1">Rp <?php echo e(number_format($book->print_price, 0, ',', '.')); ?> (cetak)</span> 
                                        <?php endif; ?>
                                        <?php if($book->ebook_price): ?>
                                        <span class="bg-secondary-soft rounded-pill my-1 my-md-0 px-3 py-0 text-dark small mx-1">Rp <?php echo e(number_format($book->ebook_price, 0, ',', '.')); ?> (pdf)</span>
                                        <?php endif; ?>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="content mt-4">
                                <div class="row g-2"> 
                                    <div class="col-6">
                                        <a href="<?php echo e(route('buku.download', $book->book_id)); ?>" target="_blank" class="btn btn-outline-dark w-100 rounded-pill py-2 shadow-sm" style="font-size: 0.95rem;">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/detail-buku.blade.php ENDPATH**/ ?>