...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-12">
      <h2 class="page-title">Data Komentar</h2>
            ...
            <tbody>
              <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e(\Illuminate\Support\Str::limit($comment->message, 50)); ?></td>
                    <td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"
                                ...
                                <?php endif; ?>
                                <a class="dropdown-item" href="<?php echo e(route('admin.comments.edit', $comment->id)); ?>">Edit</a>
                                <form action="<?php echo e(route('admin.comments.destroy', $comment->id)); ?>" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus komentar ini?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Ritecs\resources\views\backend\pages\comments\index.blade.php ENDPATH**/ ?>