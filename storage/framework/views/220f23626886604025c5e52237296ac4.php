...
<div class="container-fluid feature bg-light py-5">
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <?php $__empty_2 = true; $__currentLoopData = $haki_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
...
<div class="container-fluid py-5">
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <?php $__empty_2 = true; $__currentLoopData = $haki_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="pricing-card h-100" style="box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <div class="card-footer bg-white border-0 pt-0 pb-4">
                        <a href="https://wa.me/<?php echo e($package->whatsapp_number); ?>?text=<?php echo e(urlencode($package->whatsapp_message)); ?>" class="btn btn-success rounded-pill py-2 px-4 w-100" target="_blank">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Ritecs\resources\views\pages\haki.blade.php ENDPATH**/ ?>