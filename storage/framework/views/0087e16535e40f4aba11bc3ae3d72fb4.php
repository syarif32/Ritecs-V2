<?php $__env->startSection('content'); ?>
        ...
        <div class="container-fluid py-5" id="petunjuk-penulis">
            <div class="container">
                ...
                <div class="row g-4 justify-content-center">
                    <?php $__empty_2 = true; $__currentLoopData = $book_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
    ...
    <div class="container-fluid bg-white py-5">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <?php $__empty_2 = true; $__currentLoopData = $publishing_schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scheme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col col-12 col-xl-7">
                    <div class="timeline">
                        <?php $__empty_2 = true; $__currentLoopData = $publishing_steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Ritecs\resources\views\pages\petunjuk-penulis.blade.php ENDPATH**/ ?>