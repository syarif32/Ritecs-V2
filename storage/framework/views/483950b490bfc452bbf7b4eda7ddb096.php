...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo e(asset('assets/css/profile.css')); ?>" rel="stylesheet">
        ...
        <nav class="navbar navbar-light bg-white border-bottom d-md-none">
            <div class="container px-4">
                <div class="text-center d-flex align-items-center h-100">
                    <img src="<?php echo e(asset('assets/img/logo/logo-text.webp')); ?>" alt="Logo Ritecs" class="img-fluid sidebar-logo">
                </div>
                ...
                <div class="col-md-3 col-xl-2 d-none d-md-block sidebar bg-white mt-3 mb-5 rounded shadow-sm border-top border-primary border-5">
                    <div class="sidebar-sticky pb-3">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a aria-disabled="true" class="nav-link disabled d-none <?php echo e(($title ?? '') === 'Dashboard' ? 'active' : ''); ?>" href="<?php echo e(route('profile.dashboard')); ?>">
                                    <i class="bi bi-speedometer2 me-2"></i> Dashboard
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($title ?? '') === 'Settings' ? 'active' : ''); ?>" href="<?php echo e(route('profile.settings')); ?>">
                                    <i class="bi bi-gear me-2"></i> Profile
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($title ?? '') === 'Membership' ? 'active' : ''); ?>" href="<?php echo e(route('profile.member')); ?>">
                                    <i class="bi bi-people me-2"></i> Membership
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('logout.get')); ?>" onclick="return confirm('Konfirmasi untuk logout. Lanjurkan?')">
...
</html><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/layouts/profile.blade.php ENDPATH**/ ?>