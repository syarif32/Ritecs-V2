                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__empty_2 = true; $__currentLoopData = $book_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <tr>
                                    <td class="text-center align-middle"><i class="<?php echo e($item->icon); ?> fa-lg text-secondary"></i></td>
                                    <td class="align-middle font-weight-bold"><?php echo e($item->name); ?></td>
                                    <td class="text-center align-middle">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#editBookTypeModal"
                                                data-id="<?php echo e($item->id); ?>" data-icon="<?php echo e($item->icon); ?>" data-name="<?php echo e($item->name); ?>" title="Edit">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__empty_2 = true; $__currentLoopData = $publishing_schemes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <tr>
                                    <td class="text-center align-middle"><i class="<?php echo e($item->icon); ?> fa-lg text-info"></i></td>
                                    <td class="align-middle">
                                        <span class="d-block font-weight-bold text-dark"><?php echo e($item->title); ?></span>
                                        <small class="text-muted"><i class="fe fe-star mr-1"></i><?php echo e($item->feature); ?></small>
                                    </td>
                                    <td class="text-center align-middle">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#editSchemeModal"
                                                ...
                                                data-description="<?php echo e($item->description); ?>" data-feature="<?php echo e($item->feature); ?>" title="Edit">
                                                <i class="fe fe-edit"></i>
                                            </button>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__empty_2 = true; $__currentLoopData = $publishing_steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <tr>
                                    <td class="text-center align-middle font-weight-bold text-muted"><?php echo e($loop->iteration); ?></td>
                                    <td class="align-middle font-weight-bold text-dark"><?php echo e($item->title); ?></td>
                                    <td class="align-middle text-muted small"><?php echo e(Str::limit($item->description, 100)); ?></td>
                                    <td class="text-center align-middle">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#editStepModal"
                                                data-id="<?php echo e($item->id); ?>" data-title="<?php echo e($item->title); ?>" data-description="<?php echo e($item->description); ?>">
                                                <i class="fe fe-edit"></i>
                                            </button>
...
<div class="modal fade" id="addSchemeModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.publishing-schemes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="alert alert-info py-2 small mb-0"><?php echo $__env->make('backend.partials.icon_reference', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-primary">Simpan</button>
...
<div class="modal fade" id="addStepModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.publishing-steps.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/author_guideline/index.blade.php ENDPATH**/ ?>