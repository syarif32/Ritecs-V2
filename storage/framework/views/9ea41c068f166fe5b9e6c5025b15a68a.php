<?php $__env->startSection('content'); ?>
    ...
    <div class="header-carousel owl-carousel">
        <?php $__empty_2 = true; $__currentLoopData = $carousels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carousel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                        ...
                                        <?php if($carousel->button1_text && $carousel->button1_url): ?>
                                            <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2"
                                                href="<?php echo e($carousel->button1_url); ?>"><i
                                                    class="fas fa-play-circle me-2"></i><?php echo e($carousel->button1_text); ?></a>
                                        <?php endif; ?>
                ...
                <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="h-100">
                        ...
                        <div class="accordion" id="accordionExample">
                            <?php $__empty_2 = true; $__currentLoopData = $home_faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
