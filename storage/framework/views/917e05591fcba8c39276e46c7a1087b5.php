        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="card h-100 p-4 pt-0 border-0 shadow-sm">
                    <img src="<?php echo e(asset('storage/' . $training->image_path)); ?>" class="card-img-top rounded mt-4" alt="<?php echo e($training->title); ?>">
                    <div class="card-body p-0 pt-4 d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            ...
                            <p class="text-primary fw-bold fs-5 mb-0"><?php echo e($training->price); ?> <span class="fw-normal fs-6 text-muted"><?php echo e($training->price_period); ?></span></p>
                            ...
                            <a href="<?php echo e($training->button_url); ?>" class="btn btn-primary rounded-pill py-2 px-4" target="_blank"><?php echo e($training->button_text); ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="h-100">
                   ...
                   <h1 class="display-4 mb-4"><?php echo e($haki_subtitle->value ?? 'Lindungi Karya Anda dengan Layanan HAKI'); ?></h1>
                   <p class="mb-4"><?php echo e($haki_description->value ?? 'Deskripsi HAKI belum diatur.'); ?></p>
                    
                    <?php $__empty_1 = true; $__currentLoopData = $haki_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.4s">
                <div class="p-4 bg-light rounded">
                    <img src="<?php echo e(asset('storage/' . ($haki_image->value ?? ''))); ?>" class="img-fluid w-100 rounded" alt="HAKI Image">
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/pages/training-center.blade.php ENDPATH**/ ?>