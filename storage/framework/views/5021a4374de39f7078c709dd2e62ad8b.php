...
<div class="container-fluid">
  <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="card shadow mb-4">
            <div class="card-body">
              ...
              <form action="<?php echo e(route('admin.membership-card-settings.update')); ?>" method="POST" enctype="multipart/form-data" id="cardSettingsForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="upload-box" onclick="document.getElementById('front_image').click()">
                      ...
                      <img id="preview_front" 
                        src="<?php echo e($settings->front_image_path ? asset($settings->front_image_path) : asset('assets/img/placeholder-card.png')); ?>"
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="upload-box" onclick="document.getElementById('back_image').click()">
                      ...
                      <img id="preview_back" 
                        src="<?php echo e($settings->back_image_path ? asset($settings->back_image_path) : asset('assets/img/placeholder-card.png')); ?>"
                    ...
                    <div class="form-group">
                      ...
                      <select name="font_file" id="font_select" class="form-control preview-trigger">
                        ...
                        <?php $__currentLoopData = $fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($font['filename']); ?>" 
                            <?php echo e((isset($settings->font_file) && $settings->font_file == $font['filename']) ? 'selected' : ''); ?>>
                            <?php echo e($font['name']); ?> (<?php echo e($font['size']); ?> KB)
                          </option>
                ...
                <div class="table-responsive mt-3 rounded">
                  <table class="table table-sm table-bordered">
                    ...
                    <tbody id="font_list">
                      <?php $__currentLoopData = $fonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr data-filename="<?php echo e($font['filename']); ?>">
                        <td><?php echo e($font['name']); ?></td>
                        <td><?php echo e($font['size']); ?> KB</td>
                        <td>
                          <button type="button" class="btn btn-sm btn-danger delete-font" data-filename="<?php echo e($font['filename']); ?>">
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    ...
                    <input type="number" name="name_x" class="form-control preview-trigger" value="<?php echo e($settings->name_position['x']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Position Y</label>
                    <input type="number" name="name_y" class="form-control preview-trigger" value="<?php echo e($settings->name_position['y']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Font Size</label>
                    <input type="number" name="name_font_size" class="form-control preview-trigger" value="<?php echo e($settings->name_position['font_size']); ?>" min="12" max="100" required>
                    <small class="text-muted">Recommended: 36-60</small>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Color</label>
                    <input type="color" name="name_color" class="form-control preview-trigger" value="<?php echo e($settings->name_position['color']); ?>" required>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    <label>Position X</label>
                    <input type="number" name="member_number_x" class="form-control preview-trigger" value="<?php echo e($settings->member_number_position['x']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Position Y</label>
                    <input type="number" name="member_number_y" class="form-control preview-trigger" value="<?php echo e($settings->member_number_position['y']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Font Size</label>
                    <input type="number" name="member_number_font_size" class="form-control preview-trigger" value="<?php echo e($settings->member_number_position['font_size']); ?>" min="12" max="100" required>
                    <small class="text-muted">Recommended: 20-36</small>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Color</label>
                    <input type="color" name="member_number_color" class="form-control preview-trigger" value="<?php echo e($settings->member_number_position['color']); ?>" required>
                  </div>
                </div>
                ...
                <div class="form-row">
                  <div class="form-group col-md-3">
                    <label>Position X</label>
                    <input type="number" name="expired_x" class="form-control preview-trigger" value="<?php echo e($settings->expired_date_position['x']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Position Y</label>
                    <input type="number" name="expired_y" class="form-control preview-trigger" value="<?php echo e($settings->expired_date_position['y']); ?>" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Font Size</label>
                    <input type="number" name="expired_font_size" class="form-control preview-trigger" value="<?php echo e($settings->expired_date_position['font_size']); ?>" min="12" max="100" required>
                    <small class="text-muted">Recommended: 14-24</small>
                  </div>
                  <div class="form-group col-md-3">
                    <label>Color</label>
                    <input type="color" name="expired_color" class="form-control preview-trigger" value="<?php echo e($settings->expired_date_position['color']); ?>" required>
                  </div>
                </div>
        ...
        <div class="col-md-5">
          <div class="card shadow sticky-top" style="top: 20px;">
            ...
            <div class="card-body text-center">
              <img id="live_preview" src="<?php echo e(asset($settings->front_image_path ?? 'assets/img/placeholder-card.png')); ?>" 
    ...
    function generatePreview() {
      ...
      const url = "<?php echo e(route('admin.membership-card-preview')); ?>";
    ...
    document.getElementById('font_upload').addEventListener('change', function(e) {
        ...
        fetch("<?php echo e(route('admin.membership-card-fonts.upload')); ?>", {
            method: 'POST',
            body: formData,
            headers: {
    ...
    document.querySelectorAll('.delete-font').forEach(btn => {
      btn.addEventListener('click', function() {
        ...
        fetch("<?php echo e(route('admin.membership-card-fonts.delete')); ?>", {
          method: 'POST',
          body: formData
        })
...
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/membership-card-settings/card-settings.blade.php ENDPATH**/ ?>