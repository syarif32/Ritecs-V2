    ...
    <div class="col-12 col-lg-10 col-xl-8">
      ...
      <div class="card shadow mb-4">
        <div class="card-body">
          ...
          <?php endif; ?>
            ...
            <?php if($membership->user_id): ?>
                <div class="alert alert-info">
                    ...
                    <u><?php echo e($membership->user->full_name ?? $membership->user->email); ?></u>.
          ...
          <form id="mainForm" action="<?php echo e(route('admin.manageUserMemberships.update', $membership->membership_id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            
            <input type="hidden" name="membership_action" id="membership_action" value="">
            <input type="hidden" name="selected_user_id" id="selected_user_id" value="<?php echo e(old('selected_user_id', $membership->user_id ?? '')); ?>">
            <input type="hidden" name="guest_email_original" value="<?php echo e(old('guest_email', $membership->guest_email)); ?>">

            <div class="row">
              
              <div class="col-md-12 mb-3">
                <label>User (opsional — memilih user akan merelasikan membership guest ke user tersebut)</label>
                <select id="user_select" name="user_id" class="form-control" <?php if($membership->user_id): ?> disabled <?php endif; ?>>
                  ...
                  <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($u->user_id); ?>"
                        ...
                        <?php echo e(($membership->user_id && $membership->user_id == $u->user_id) ? 'selected' : ''); ?>>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="guest_first_name" name="guest_first_name" class="form-control" value="<?php echo e(old('guest_first_name', $membership->guest_first_name)); ?>">
              </div>
              <div class="col-md-6 mb-3">
                <label>Last Name</label>
                <input type="text" id="guest_last_name" name="guest_last_name" class="form-control" value="<?php echo e(old('guest_last_name', $membership->guest_last_name)); ?>">
              </div>
...
unset($__errorArgs, $__bag); ?>"
                         value="<?php echo e(old('guest_email', $membership->guest_email)); ?>">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="guest_institution" name="guest_institution" class="form-control" value="<?php echo e(old('guest_institution', $membership->guest_institution)); ?>">
              </div>
...
unset($__errorArgs, $__bag); ?>" 
                         value="<?php echo e(old('member_number', $membership->member_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6 mb-3">
                ...
                <select name="status" class="form-control">
                  <option value="1" <?php echo e(old('status', $membership->status) == 1 ? 'selected' : ''); ?>>Active</option>
                  <option value="0" <?php echo e(old('status', $membership->status) == 0 ? 'selected' : ''); ?>>Inactive</option>
                </select>
              </div>

              <div class="col-md-6 mb-3">
                <label>Start Date</label>
                <input type="date" class="form-control" name="start_date" value="<?php echo e(old('start_date', $membership->start_date)); ?>" required>
              </div>
              <div class="col-md-6 mb-3">
                <label>End Date</label>
                <input type="date" class="form-control" name="end_date" value="<?php echo e(old('end_date', $membership->end_date)); ?>" required>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-warning">
          <b>Konsekuensi:</b>
          <ul class="mb-0">
            <li>Relasi ke user <u><?php echo e($membership->user->email); ?></u> akan dilepas.</li>
...
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/manage-user-membership/edit.blade.php ENDPATH**/ ?>