                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm mr-3">
                                                    <img src="<?php echo e($user->img_path ? asset($user->img_path) : asset('backend/assets/images/user.svg')); ?>" alt="..." class="avatar-img rounded-circle">
                                                </div>
                                                <div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="password" class="form-control" name="admin_password" id="pass-promote-<?php echo e($user->user_id); ?>" required placeholder="Password Login Anda">
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-secondary" type="button" onclick="togglePassword('pass-promote-<?php echo e($user->user_id); ?>', this)">
                                                                        <i class="fe fe-eye"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                ...
                                                <form action="<?php echo e(route('admin.users.demote', $user->user_id)); ?>" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="password" class="form-control" name="admin_password" id="pass-demote-<?php echo e($user->user_id); ?>" required placeholder="Password Login Anda">
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-secondary" type="button" onclick="togglePassword('pass-demote-<?php echo e($user->user_id); ?>', this)">
                                                                        <i class="fe fe-eye"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/usersmanagement/index.blade.php ENDPATH**/ ?>