...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="fe fe-alert-circle"></i> Gunakan fitur ini hanya ketika aplikasi Laravel terasa lambat atau terjadi
            kesalahan saat memuat halaman.
            ...
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card border-left-warning shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted small">Menghapus cache konfigurasi agar perubahan file & config terbaca ulang.
                        </p>
            ...
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card border-left-dark shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted small">Menghapus semua file aktivitas di storage/logs secara permanen. Tindakan
                            ini dapat mengurangi beban memori & menjaga kinerja server tetap optimal.</p>
            ...
            <div class="col-md-6 col-xl-3 mb-4">
                <div class="card border-left-success shadow h-100 py-3">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted small">Membangun ulang cache (config, route, view, dll). Direkomendasikan setelah menjalankan Clear Optimaze</p>
