                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="haki_intro_title" class="form-control" value="<?php echo e($haki_intro_title->value); ?>">
                        </div>
                        <div class="form-group">
                            <label class="font-weight-bold">Subjudul</label>
                            <input type="text" name="haki_intro_subtitle" class="form-control" value="<?php echo e($haki_intro_subtitle->value); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="font-weight-bold">Deskripsi</label>
                            <textarea name="haki_intro_description" class="form-control" rows="5"><?php echo e($haki_intro_description->value); ?></textarea>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php $__empty_2 = true; $__currentLoopData = $haki_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <tr>
                                <td class="text-center align-middle">
                                    <i class="<?php echo e($item->icon); ?> fa-lg text-secondary"></i>
                                </td>
                                ...
                                <td class="text-center align-middle">
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="<?php echo e(route('admin.haki-types.destroy', $item)); ?>" method="POST" class="d-inline">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php $__empty_2 = true; $__currentLoopData = $haki_packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <tr>
                                <td class="align-middle font-weight-bold"><?php echo e($item->title); ?></td>
                                <td class="align-middle text-success font-weight-bold">
                                    Rp. <?php echo e(number_format($item->new_price, 0, ',', '.')); ?>
                                ...
                                <td class="text-center align-middle">
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="<?php echo e(route('admin.haki-packages.destroy', $item)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u604135968/domains/ritecs.org/config/resources/views/backend/pages/haki/index.blade.php ENDPATH**/ ?>